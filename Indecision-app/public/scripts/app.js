...
var IndecisionApp = function (_React$Component) {
  ...
  _createClass(IndecisionApp, [{
    ...
    value: function handlePick() {
      ...
      var chooseoption = this.state.options[randomNum];
      alert(chooseoption);
    }
  }, {
    key: "handleAddOption",
...
var Header = function Header(props) {
  return React.createElement(
    ...
    React.createElement(
      "h1",
      { style: { color: "none", fontSize: "32px" } },
      props.title
    ),
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      props.options.map(function (value, index) {
        return React.createElement(Option, { key: index, optionText: value, handleDeleteOption: props.handleDeleteOption });
      })
    )
  );
  //}
